...
class Server {
   ...
   */ async handleApiRequest(req, res, pathname, query) {
    ...
    async renderToResponseWithComponents({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        if (isSSG) {
            isManualRevalidate = (0, _apiUtils).checkIsManualRevalidate(process.env._REVALIDATE_SSG ? { headers: { 'x-prerender-revalidate': this.renderOpts.previewProps.previewModeId } } : req, this.renderOpts.previewProps);
        }
