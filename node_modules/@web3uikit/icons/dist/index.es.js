...
const SvgCoupon = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    d: "M7.97 7.42a1.5 1.5 0 1 1-2.122-2.122 1.5 1.5 0 0 1 2.121 2.121Z"
  })]
});
const SvgCreditCard = ({
  title,
...
const SvgFilterAlt = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    d: "M10 17a1 1 0 0 0 1 1h2a1 1 0 1 0 0-2h-2a1 1 0 0 0-1 1ZM4 6a1 1 0 0 0 0 2h16a1 1 0 1 0 0-2H4Zm2 6a1 1 0 0 0 1 1h10a1 1 0 1 0 0-2H7a1 1 0 0 0-1 1Z"
  })]
});
const SvgFilter = ({
  title,
...
const SvgInstagram = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    d: "M8.178 1.165c-3.34 0-6.04 2.71-6.04 6.05v9.57c0 3.34 2.71 6.05 6.05 6.05h9.57c3.34 0 6.05-2.71 6.05-6.05v-9.57c0-3.34-2.71-6.05-6.05-6.05h-9.58Zm13.74 15.44c0 2.44-1.98 4.42-4.42 4.42h-9.04c-2.44 0-4.42-1.98-4.42-4.42v-9.03c0-2.44 1.98-4.42 4.42-4.42h9.04c2.44 0 4.42 1.98 4.42 4.42v9.04-.01Z"
  }), /* @__PURE__ */ jsx("path", {
    d: "M12.978 6.385c-3.14 0-5.68 2.54-5.68 5.68 0 3.14 2.54 5.68 5.68 5.68 3.14 0 5.68-2.54 5.68-5.68 0-3.14-2.54-5.68-5.68-5.68Zm-.02 9.24c-1.99 0-3.6-1.61-3.6-3.6s1.61-3.6 3.6-3.6 3.6 1.61 3.6 3.6-1.61 3.6-3.6 3.6ZM18.748 7.535a1.33 1.33 0 1 0 0-2.66 1.33 1.33 0 0 0 0 2.66Z"
  })]
});
...
const SvgLiquidity = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    d: "M12 22.32c-2.4 0-4.66-.93-6.36-2.63A8.948 8.948 0 0 1 3 13.32c0-2.4.93-4.66 2.63-6.36l5.66-5.67A.99.99 0 0 1 12 1c.27 0 .52.11.71.29l5.66 5.66c3.51 3.51 3.51 9.22 0 12.73a8.942 8.942 0 0 1-6.36 2.64H12Zm0-18.9L7.06 8.37a6.941 6.941 0 0 0-2.05 4.96c0 1.87.73 3.63 2.05 4.95a7.007 7.007 0 0 0 9.9 0 7.007 7.007 0 0 0 0-9.9L12 3.42Z"
  }), /* @__PURE__ */ jsx("path", {
    d: "M7.25 15.25c-.43 0-.8-.31-.88-.74-.4-2.3.56-4.64 2.59-6.25.35-.35.88-.32 1.23.03s.31.95-.04 1.29c-.02.02-.05.05-.08.07-1.53 1.22-2.24 2.88-1.94 4.55.09.49-.24.95-.72 1.03-.05 0-.1.01-.16.01v.01ZM8.63 18.03c-.25 0-.5-.1-.67-.3-.07-.08-.13-.15-.19-.23a.902.902 0 0 1 .13-1.26c.38-.32.95-.25 1.26.13l.15.18a.889.889 0 0 1-.67 1.48h-.01Z"
  })]
});
const SvgList = ({
  title,
...
const SvgMagicWand = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    d: "M18.94 6.23a.803.803 0 0 0-1.13 0l-2.5 2.5c-.31.31-.31.82 0 1.13.16.16.36.23.57.23.21 0 .41-.08.57-.23l2.5-2.5c.31-.31.31-.82 0-1.13h-.01ZM13.65 5.55l-2.21-.82-.82-2.21A.812.812 0 0 0 9.87 2c-.33 0-.63.21-.75.52L8.3 4.73l-2.21.82c-.31.12-.52.42-.52.75s.21.63.52.75l2.21.82.82 2.21c.12.31.42.52.75.52s.63-.21.75-.52l.82-2.21 2.21-.82c.31-.12.52-.42.52-.75s-.21-.63-.52-.75Zm-3.11.94a.78.78 0 0 0-.47.47l-.19.53-.2-.53a.78.78 0 0 0-.47-.47l-.53-.19.53-.19a.78.78 0 0 0 .47-.47l.2-.53.19.53c.08.22.25.39.47.47l.53.19-.53.19ZM21.65 12.05l-1.11-.41-.41-1.11a.812.812 0 0 0-.75-.52c-.33 0-.63.21-.75.52l-.41 1.11-1.11.41c-.31.12-.52.42-.52.75s.21.63.52.75l1.11.41.41 1.11c.12.31.42.52.75.52s.63-.21.75-.52l.41-1.11 1.11-.41c.31-.12.52-.42.52-.75s-.21-.63-.52-.75ZM12.81 11.23 2.43 20.86c-1.3 1.26.62 3.17 1.88 1.88l9.63-10.37c.69-.74-.39-1.82-1.13-1.13v-.01Z"
  })]
});
const SvgMail = ({
  title,
...
const SvgPause = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    d: "M9 4H7a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1ZM17 4h-2a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1Z"
  })]
});
const SvgPhone = ({
  title,
...
const SvgPlay = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    d: "M5 4.832a1 1 0 0 1 1.54-.842l11.152 7.169a1 1 0 0 1 0 1.682L6.54 20.01A1 1 0 0 1 5 19.17V4.831Z"
  })]
});
const SvgPlayground = ({
  title,
...
const SvgReferenceApi = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M6.518 3.524c-.93 0-1.682.753-1.682 1.683v6.49a.71.71 0 0 1-1.42 0v-6.49a3.102 3.102 0 0 1 3.102-3.103h12.794a3.102 3.102 0 0 1 3.103 3.103v8.686a3.102 3.102 0 0 1-3.103 3.102h-3.758a.71.71 0 0 1 0-1.42h3.758c.93 0 1.683-.753 1.683-1.682V5.207c0-.93-.753-1.683-1.683-1.683H6.518Z"
  }), /* @__PURE__ */ jsx("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M3.634 6.485a.71.71 0 0 1 .71-.71h16.804a.71.71 0 1 1 0 1.42H4.344a.71.71 0 0 1-.71-.71Z"
  }), /* @__PURE__ */ jsx("path", {
    d: "M6.518 5.207a.546.546 0 1 0 0-1.093.546.546 0 0 0 0 1.093ZM8.572 5.207a.546.546 0 1 0 0-1.093.546.546 0 0 0 0 1.093ZM10.616 5.207a.546.546 0 1 0 0-1.093.546.546 0 0 0 0 1.093Z"
  }), /* @__PURE__ */ jsx("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M13.444 12.374a.71.71 0 0 1 .71-.71h4.354a.71.71 0 1 1 0 1.42h-4.354a.71.71 0 0 1-.71-.71ZM11.85 9.599a.71.71 0 0 1 .71-.71h5.948a.71.71 0 0 1 0 1.42H12.56a.71.71 0 0 1-.71-.71Z"
  }), /* @__PURE__ */ jsx("path", {
    d: "M10.222 16.908a2.299 2.299 0 0 1-2.305 2.305 2.299 2.299 0 0 1-2.305-2.305c0-.24.043-.459.109-.667.186.394.579.667 1.049.667.634 0 1.158-.514 1.158-1.147 0-.46-.273-.863-.667-1.038.219-.066.438-.11.667-.11a2.299 2.299 0 0 1 2.305 2.306l-.01-.011Zm3.42-.197a.618.618 0 0 1 0 .394c-.076.23-.175.448-.284.655-1.093 2.305-3.168 3.759-5.452 3.759-1.715 0-3.332-.82-4.48-2.218a6.34 6.34 0 0 1-1.048-1.705c-.066-.164-.142-.328-.197-.491a.618.618 0 0 1 0-.394c.066-.164.131-.338.197-.491a6.515 6.515 0 0 1 1.049-1.705c1.158-1.398 2.764-2.218 4.48-2.218 2.283 0 4.348 1.454 5.45 3.748.1.218.198.437.285.666Zm-1.169.197s-.044-.087-.055-.131c-.065-.164-.153-.328-.23-.48a5.31 5.31 0 0 1-.13-.252c-.94-1.606-2.48-2.6-4.141-2.6-.371 0-.743.065-1.103.163a5.267 5.267 0 0 0-2 1.137c-.044.033-.076.065-.12.098s-.077.076-.12.12a6.33 6.33 0 0 0-1.202 1.858c0 .032-.022.054-.033.076 0 .022.022.055.033.077a5.92 5.92 0 0 0 1.202 1.857c.043.044.076.087.12.131.033.033.076.066.12.098a5.505 5.505 0 0 0 2 1.137c.36.098.72.163 1.103.163 1.672 0 3.201-.994 4.14-2.6.044-.076.088-.164.132-.251.076-.153.153-.306.23-.48a.67.67 0 0 0 .054-.132v.011Z"
  }), /* @__PURE__ */ jsx("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M7.906 12.407c-1.679 0-3.255.802-4.395 2.178l-.001.001a6.406 6.406 0 0 0-1.032 1.676c-.043.1-.085.21-.129.32l-.066.17a.51.51 0 0 0 .002.318c.035.105.078.208.123.314l.07.17A6.232 6.232 0 0 0 3.51 19.23l.002.002c1.129 1.376 2.716 2.178 4.395 2.178 2.234 0 4.276-1.422 5.353-3.696l.002-.004c.107-.203.203-.416.277-.639l.002-.006a.508.508 0 0 0-.001-.316c-.086-.225-.182-.44-.28-.657-1.089-2.263-3.12-3.684-5.353-3.684Zm-4.563 2.038c1.176-1.42 2.812-2.257 4.563-2.257 2.333 0 4.432 1.484 5.55 3.81l.002.002v.001c.098.218.198.439.286.671l.002.005a.727.727 0 0 1-.001.465 4.505 4.505 0 0 1-.29.667c-1.107 2.336-3.217 3.819-5.549 3.819-1.75 0-3.397-.836-4.563-2.257a6.45 6.45 0 0 1-1.066-1.732v-.002l-.066-.157c-.047-.111-.096-.228-.134-.34a.728.728 0 0 1 .003-.47l.064-.163c.044-.112.089-.227.133-.33a6.624 6.624 0 0 1 1.066-1.732Zm3.442-.942c.366-.1.748-.168 1.132-.168 1.707 0 3.28 1.022 4.235 2.655l.004.006c.044.088.086.173.128.246l.003.005.045.09c.037.072.075.148.112.226l.138-.553v1.36l-.104-.208c-.064.141-.128.269-.19.395l-.002.002c-.043.087-.088.176-.133.255v.001c-.956 1.633-2.518 2.655-4.236 2.655-.395 0-.766-.068-1.132-.168l-.005-.001a5.614 5.614 0 0 1-2.035-1.156 1.21 1.21 0 0 1-.128-.106c-.025-.024-.046-.048-.064-.07h-.001a1.207 1.207 0 0 0-.055-.06l-.002-.002a6.029 6.029 0 0 1-1.228-1.899l-.013-.024c-.007-.013-.024-.048-.024-.087v-.026l.011-.023.016-.026.006-.01v-.014l.008-.02a6.438 6.438 0 0 1 1.223-1.89l.002-.002c.014-.013.025-.025.037-.039l.021-.022a.568.568 0 0 1 .074-.07c.019-.013.036-.027.055-.044.018-.016.038-.033.061-.05a5.378 5.378 0 0 1 2.038-1.157h.003Zm5.53 3.309a.74.74 0 0 0 .035.092l.003.006a1.19 1.19 0 0 1-.032.07l-.003.004c-.075.172-.15.323-.227.476-.044.088-.086.172-.128.245-.924 1.58-2.42 2.546-4.046 2.546-.369 0-.718-.063-1.072-.16a5.395 5.395 0 0 1-1.958-1.112l-.007-.006a1.063 1.063 0 0 1-.109-.088 1.198 1.198 0 0 1-.055-.06v-.002c-.02-.02-.04-.044-.064-.069a5.81 5.81 0 0 1-1.179-1.822l-.003-.007a.472.472 0 0 0-.01-.018.197.197 0 0 0 .02-.06 6.218 6.218 0 0 1 1.28-1.917c.024-.018.046-.036.064-.052l.001-.001.055-.045.007-.006a5.157 5.157 0 0 1 1.957-1.113c.354-.096.715-.16 1.073-.16 1.614 0 3.12.967 4.045 2.544.042.085.086.173.13.25l.047.093c.063.123.125.247.176.372Zm-4.771-2.048c.3.227.493.593.493.997a1.266 1.266 0 0 1-2.276.757c-.025.124-.04.254-.04.39a2.19 2.19 0 0 0 2.196 2.196 2.19 2.19 0 0 0 2.196-2.196v-.21a2.189 2.189 0 0 0-2.185-1.975c-.13 0-.257.015-.384.04Zm2.775 2.395a2.407 2.407 0 0 1-2.402 2.164 2.408 2.408 0 0 1-2.415-2.415c0-.254.047-.484.115-.7l.084-.265.119.252c.168.357.524.604.95.604.575 0 1.049-.466 1.049-1.038 0-.416-.248-.78-.602-.938l-.27-.12.283-.085a2.41 2.41 0 0 1 .698-.114 2.408 2.408 0 0 1 2.414 2.415v.264l-.023-.024Z"
  })]
});
const SvgReload = ({
  title,
...
const SvgStartFast = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    d: "M11.103 12.014c0 .428.34.769.769.769h4.295L14.41 14.54a.776.776 0 0 0 0 1.087.776.776 0 0 0 1.088 0l3.076-3.076a.776.776 0 0 0 0-1.087l-3.076-3.076a.776.776 0 0 0-1.088 0 .776.776 0 0 0 0 1.087l1.758 1.758h-4.295a.764.764 0 0 0-.77.769v.01Z"
  }), /* @__PURE__ */ jsx("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M10.733 4.485a8.53 8.53 0 0 1 4.127-1.05 8.65 8.65 0 0 1 8.657 8.656 8.65 8.65 0 0 1-12.78 7.609.769.769 0 1 1 .73-1.354A7.115 7.115 0 0 0 21.98 12.09a7.112 7.112 0 0 0-7.12-7.119 6.992 6.992 0 0 0-3.386.861.769.769 0 0 1-.74-1.348ZM.315 12.113c0-.425.344-.77.769-.77H6.18a.769.769 0 0 1 0 1.539H1.084a.769.769 0 0 1-.77-.77ZM3.644 15.189c0-.425.344-.77.769-.77h4.58a.769.769 0 0 1 0 1.539h-4.58a.769.769 0 0 1-.77-.77ZM2.325 9.026c0-.425.345-.77.77-.77h5.899a.769.769 0 0 1 0 1.539h-5.9a.769.769 0 0 1-.769-.77Z"
  })]
});
const SvgStreams = ({
  title,
...
const SvgYoutube = ({
  ...
  children: [title ? /* @__PURE__ */ jsx("title", {
    ...
    d: "M23.646 9.27c-.065-.892-.046-.23-.294-2.315-.028-.202-.064-.515-.211-.91a2.858 2.858 0 0 0-.671-1.038c-.413-.413-.836-.588-.955-.643a2.246 2.246 0 0 0-.616-.156c-1.819-.266-2.608-.266-2.608-.266-1.672 0-.919-.12-4.134-.156-1.8-.019-1.369.027-4.29.027-.009 0-3.362 0-4.877.156-.515.055-.652.11-1.305.157-.34.027-.56.027-.881.137a3.463 3.463 0 0 0-.69.322c-.293.165-.541.34-.716.477a5.754 5.754 0 0 0-.615 1.094c-.276.652-.368 1.23-.45 2.746a52.76 52.76 0 0 0-.083 3.224c0 1.314.055 2.04.083 2.343.046.633.046.303.183 1.736.074.762.101 1.056.267 1.497.064.165.22.523.505.91.138.183.33.44.643.67.404.294.8.395 1.066.45 1.414.312 2.425.349 2.425.349 3.123.101 2.498.128 3.812.138.716 0 1.68-.01 2.829-.055 0 0 1.975 0 4.767-.083 2.342-.064.551-.064 2.315-.138.174 0 .799-.037 1.598-.184.478-.091.717-.174.955-.294.12-.064.487-.257.855-.642.12-.12.33-.359.505-.717.083-.165.128-.312.156-.423a31.8 31.8 0 0 0 .533-5.3 31.216 31.216 0 0 0-.11-3.095l.009-.019ZM9.71 15.47V8.434l6.191 3.554-6.19 3.482Z"
  })]
});
export { SvgAda as Ada, SvgAddUser as AddUser, SvgAirdrop as Airdrop, SvgAlertCircle as AlertCircle, SvgAlertTriangle as AlertTriangle, SvgArchive as Archive, SvgArrow as Arrow, SvgArrowCircleDown as ArrowCircleDown, SvgArrowCircleLeft as ArrowCircleLeft, SvgArrowCircleRight as ArrowCircleRight, SvgArrowDown as ArrowDown, SvgArrowDownLeft as ArrowDownLeft, SvgArrowDownRight as ArrowDownRight, SvgArrowLeft as ArrowLeft, SvgArrowUp as ArrowUp, SvgArrowUpLeft as ArrowUpLeft, SvgArrowUpRight as ArrowUpRight, SvgAtomicApi as AtomicApi, SvgAvax as Avax, SvgBalancer as Balancer, SvgBan as Ban, SvgBean as Bean, SvgBeans as Beans, SvgBell as Bell, SvgBin as Bin, SvgBlueBean as BlueBean, SvgBnb as Bnb, SvgBook as Book, SvgBtc as Btc, SvgCalendar as Calendar, SvgCamera as Camera, SvgCart as Cart, SvgCartBag as CartBag, SvgCat as Cat, SvgChainlink as Chainlink, SvgChart as Chart, SvgCheck as Check, SvgCheckCircle as CheckCircle, SvgCheckCircleAlt as CheckCircleAlt, SvgCheckSquare as CheckSquare, SvgCheckmark as Checkmark, SvgChevronDown as ChevronDown, SvgChevronLeft as ChevronLeft, SvgChevronLeft2X as ChevronLeft2X, SvgChevronRight as ChevronRight, SvgChevronRight2X as ChevronRight2X, SvgChevronUp as ChevronUp, SvgCloud as Cloud, SvgCog as Cog, SvgCompass as Compass, SvgContract as Contract, SvgCopy as Copy, SvgCoupon as Coupon, SvgCreditCard as CreditCard, SvgCreditCard2 as CreditCard2, SvgCross as Cross, SvgCrossCircle as CrossCircle, SvgCube as Cube, SvgCurve as Curve, SvgDai as Dai, SvgDapps as Dapps, SvgData as Data, SvgDiscord as Discord, SvgDiscord2 as Discord2, SvgDoge as Doge, SvgDownload as Download, SvgDownloadCloud as DownloadCloud, SvgDribbble as Dribbble, SvgEdit as Edit, SvgEditAlt as EditAlt, SvgErc20 as Erc20, SvgEth as Eth, SvgEthColored as EthColored, SvgEtherscan as Etherscan, SvgEvent as Event, SvgExchange as Exchange, SvgExclamation as Exclamation, SvgExpand as Expand, SvgExternalLink as ExternalLink, SvgEye as Eye, SvgEyeClosed as EyeClosed, SvgFacebookFill as FacebookFill, SvgFil as Fil, SvgFile as File, SvgFilter as Filter, SvgFilterAlt as FilterAlt, SvgFirebaseLogo as FirebaseLogo, SvgGift as Gift, SvgGiftOpen as GiftOpen, SvgGithub as Github, SvgGmail as Gmail, SvgGoogle as Google, SvgGrid as Grid, SvgHandCoin as HandCoin, SvgHeart as Heart, SvgHeartFilled as HeartFilled, SvgHelpCircle as HelpCircle, SvgHolders as Holders, SvgHome as Home, SvgImage as Image, SvgInfo as Info, SvgInstagram as Instagram, SvgIntegration as Integration, SvgKey as Key, SvgLayout as Layout, SvgLearn as Learn, SvgLifeRing as LifeRing, SvgLightbulb as Lightbulb, SvgLink as Link, SvgLinkedin as Linkedin, SvgLinux as Linux, SvgLiquidity as Liquidity, SvgList as List, SvgLockClosed as LockClosed, SvgLockOpen as LockOpen, SvgLockReset as LockReset, SvgLogIn as LogIn, SvgLogOut as LogOut, SvgMagicWand as MagicWand, SvgMail as Mail, SvgMastercard as Mastercard, SvgMatic as Matic, SvgMaximize as Maximize, SvgMenu as Menu, SvgMessageCircle as MessageCircle, SvgMessageSquare as MessageSquare, SvgMetamask as Metamask, SvgMetamaskLined as MetamaskLined, SvgMinimize as Minimize, SvgMinus as Minus, SvgMinusCircle as MinusCircle, SvgMonitor as Monitor, SvgMore as More, SvgMoreVert as MoreVert, SvgNetwork as Network, SvgNftCat as NftCat, SvgNoData as NoData, SvgOff as Off, SvgOneinch as Oneinch, SvgOpensea as Opensea, SvgOverview as Overview, SvgPaperclip as Paperclip, SvgPause as Pause, SvgPauseCircle as PauseCircle, SvgPhone as Phone, SvgPieChart as PieChart, SvgPin as Pin, SvgPlay as Play, SvgPlayCricle as PlayCricle, SvgPlayground as Playground, SvgPlug as Plug, SvgPlus as Plus, SvgPulse as Pulse, SvgReddit as Reddit, SvgRedditFill as RedditFill, SvgReferenceApi as ReferenceApi, SvgReload as Reload, SvgRoadmap as Roadmap, SvgRocket as Rocket, SvgRocketColored as RocketColored, SvgSandbox as Sandbox, SvgSandbox2 as Sandbox2, SvgSave as Save, SvgSearch as Search, SvgSend as Send, SvgServer as Server, SvgShare as Share, SvgShareAlt as ShareAlt, SvgShib as Shib, SvgShield as Shield, SvgShieldOff as ShieldOff, SvgShopping as Shopping, SvgSlack as Slack, SvgSleepyCat as SleepyCat, SvgSolana as Solana, SvgSolanaColored as SolanaColored, SvgSpeedyNode as SpeedyNode, SvgStar as Star, SvgStars as Stars, SvgStartFast as StartFast, SvgStreams as Streams, SvgSushiSwap as SushiSwap, SvgSwap as Swap, SvgTarget as Target, SvgTelegram as Telegram, SvgTelegramFill as TelegramFill, SvgTestnet as Testnet, SvgToken as Token, SvgTokenColored as TokenColored, SvgTokens as Tokens, SvgToolbox as Toolbox, SvgToolboxAlt as ToolboxAlt, SvgTrending as Trending, SvgTriangleDown as TriangleDown, SvgTriangleUp as TriangleUp, SvgTv as Tv, SvgTwitch as Twitch, SvgTwitter as Twitter, SvgTwitterOutline as TwitterOutline, SvgUni as Uni, SvgUpdate as Update, SvgUsdc as Usdc, SvgUsdt as Usdt, SvgUser as User, SvgUserTeam as UserTeam, SvgVideo as Video, SvgVisa as Visa, SvgWallet as Wallet, SvgWeb3Api as Web3Api, SvgWhale as Whale, SvgWindows as Windows, SvgWithdraw as Withdraw, SvgXrp as Xrp, SvgYellowBean as YellowBean, SvgYoutube as Youtube, SvgYoutubeSchool as YoutubeSchool };
